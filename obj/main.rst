...
Hexadecimal [16-Bits]
                             ...
                             21 .include "manager/entities.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             35 
                             36 ;; 
                             37 ;; Declare all function entry points as global symbols for the compiler.
                             38 ;; (The linker will know what to do with them)
                             39 ;; WARNING: Every global symbol declared will be linked, so DO NOT declare 
                             40 ;; symbols for functions you do not use.
                             41 ;;
                             42 .globl cpct_disableFirmware_asm
                             43 .globl cpct_getScreenPtr_asm
                             44 .globl sys_render_update
                             45 .globl sys_physics_update
                             46 .globl sys_render_wait
                             47 .globl cpct_waitVSYNC_asm
                             48 
                     00D8    49 cmps == e_cmps_position | e_cmps_alive | e_cmps_render | e_cmps_physics 
                             50 
                             51 ;; Structure of templates:
                             52 ;;                   cmps - x - y - vx - vy - color - e_type
   4010 D8 00 00 00 00 FF    53 mainchar_entity:: .db cmps, #0x00, #0x00, 0, 0, #0xFF , e_type_mainchar
        00
                             54 
                     00F8    55 cmps == e_cmps_position | e_cmps_alive | e_cmps_physics | e_cmps_render| e_cmps_input
   4017 F8 12 10 00 00 F0    56 enemy_entity:: .db cmps, #0x12, #0x10, 0,0, #0xF0, e_type_enemy
        01
                             57 
   401E                      58 _main::
                             59    ;; Disable firmware to prevent it from interfering with string drawing
   401E CD 63 45      [17]   60    call cpct_disableFirmware_asm
                             61 
                             62    
                             63    
                             64    ;; call man_entity_init
                             65    ;; call sys_render_init
                             66 
   4021 21 10 40      [10]   67    ld hl, #mainchar_entity 
   4024 CD 89 44      [17]   68    call man_entity_create
                             69 
   4027 21 17 40      [10]   70    ld hl, #enemy_entity
   402A CD 89 44      [17]   71    call man_entity_create
                             72 
                             73 
                             74    ;; Loop forever
...
Hexadecimal [16-Bits]
   ...
   402D                      75 loop:
   402D CD 90 40      [17]   76    call sys_physics_update
   4030 CD C9 40      [17]   77    call sys_render_update
   4033 CD F9 40      [17]   78    call sys_render_wait
   4036 CD 58 45      [17]   79    call cpct_waitVSYNC_asm
   4039 18 F2         [12]   80    jr    loop
