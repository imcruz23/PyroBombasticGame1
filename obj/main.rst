...
Hexadecimal [16-Bits]
                             ...
                             48 
                     00F8    49 cmps == e_cmps_position | e_cmps_alive | e_cmps_render | e_cmps_physics | e_cmps_input
                             50 
                             51 ;; Structure of templates:
                             52 ;;                   cmps - x - y - vx - vy - color - e_type
   4010 F8 00 00 00 00 FF    53 mainchar_entity:: .db cmps, #0x00, #0x00, 0, 0, #0xFF , e_type_mainchar
        00
                             54 
                     00D8    55 cmps == e_cmps_position | e_cmps_alive | e_cmps_physics | e_cmps_render
   4017 D8 12 10 00 00 F0    56 enemy_entity:: .db cmps, #0x12, #0x10, 0,0, #0xF0, e_type_enemy
        01
                             57 
   401E                      58 _main::
                             59    ;; Disable firmware to prevent it from interfering with string drawing
   401E CD 2B 46      [17]   60    call cpct_disableFirmware_asm
                             61 
                             62    
                             63    
   ...
   4024 CD 51 45      [17]   68    call man_entity_create
                             69 
   4027 21 17 40      [10]   70    ld hl, #enemy_entity
   402A CD 51 45      [17]   71    call man_entity_create
                             72 
                             73 
                             74    ;; Loop forever
...
Hexadecimal [16-Bits]
   ...
   4036 CD 20 46      [17]   79    call cpct_waitVSYNC_asm
