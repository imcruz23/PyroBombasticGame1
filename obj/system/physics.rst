...
Hexadecimal [16-Bits]
                              ...
                              4 .include "./manager/entities.h.s"
...
Hexadecimal [16-Bits]
                              ...
                              5 .globl man_entity_forall
                              6 .globl man_entity_create
                              7 .globl cpct_isKeyPressed_asm
                              8 .globl cpct_scanKeyboard_asm
                              9 
                             10 ;; ----------------------------------------
                             11 ;; Puts actions in certain keys
                             12 ;; ----------------------------------------
   403B                      13 keyactions::
   403B 04 04 51 40          14     .dw Key_O, key_left_action
   403F 03 08 56 40          15     .dw Key_P, key_right_action
   4043 08 08 5B 40          16     .dw Key_Q, key_up_action
   4047 08 20 60 40          17     .dw Key_A, key_down_action
   404B 05 80 65 40          18     .dw Key_Space, key_space_action
   404F 00 00                19     .dw 0x0000
                             20 
                             21 ;; ------------------------------------
                             22 ;;  Horizontal movement
                             23 ;; ------------------------------------
   4051                      24 key_left_action::
   4051 DD 36 03 FF   [19]   25     ld e_vx(ix), #-1
   4055 C9            [10]   26 ret
                             27 
   4056                      28 key_right_action::
   4056 DD 36 03 01   [19]   29     ld e_vx(ix), #1
   405A C9            [10]   30 ret
                             31 
                             32 ;; ------------------------------------
                             33 ;;  Vertical movement
                             34 ;; ------------------------------------
   405B                      35 key_up_action::
   405B DD 36 04 FE   [19]   36     ld e_vy(ix), #-2
   405F C9            [10]   37 ret
                             38 
   4060                      39 key_down_action::
   4060 DD 36 04 02   [19]   40     ld e_vy(ix), #2
   4064 C9            [10]   41 ret
                             42 
                             43 ;; ------------------------------------
                             44 ;;  Extra action: shoot
                             45 ;; ------------------------------------
   4065                      46 key_space_action::
                             47     ;; TODO
   4065 C9            [10]   48 ret
                             49 
                             50 ;;cmps2 == e_cmps_position | e_cmps_alive | e_cmps_render | e_cmps_physics
                             51  ;;bullet_entity:: .db cmps2, #0x1A, #0x1A, 2, 0, #0xFF , e_type_bullet
                             52 ;; Structure of templates:
                             53 ;;          cmps(entities.h.s) -- x -- y -- e_type (entities.h.s)
                             54 
                             55 
   4066                      56 sys_physics_keyboard::
   4066 DD 36 03 00   [19]   57     ld e_vx(ix), #0
   406A DD 36 04 00   [19]   58     ld e_vy(ix), #0
   406E FD 21 37 40   [14]   59     ld iy, #keyactions-4
...
Hexadecimal [16-Bits]
                             ...
                             60     
                             61     ;; Checks if any key is pressed
   4072                      62     nextkey:
   4072 01 04 00      [10]   63         ld bc, #4
   4075 FD 09         [15]   64         add iy, bc
                             65         
                             66         ;; Check next key code
   4077 FD 6E 00      [19]   67         ld l, (iy)
   407A FD 66 01      [19]   68         ld h, 1(iy)
                             69         
                             70         ;; Check for null to end
   407D 7D            [ 4]   71         ld a, l
   407E B4            [ 4]   72         or h
   407F C8            [11]   73         ret z
                             74 
   ...
   4085 21 72 40      [10]   80     ld hl, #nextkey
   4088 E5            [11]   81     push hl
   4089 FD 6E 02      [19]   82     ld l, 2(iy)
   408C FD 66 03      [19]   83     ld h, 3(iy)
   408F E9            [ 4]   84     jp (hl)
                             85 
                             86 ;; --------------------------------------
                             87 ;;  Update all entities' physics
                             88 ;;  B -> mask for filter
                             89 ;; --------------------------------------
                             90 
   ...
   4098 C9            [10]   95 ret
                             96 
                             97 
   4099                      98 sys_update_bullets::
   4099 DD 7E 03      [19]   99     ld a, e_vx(ix);;vx
   409C DD 46 01      [19]  100     ld b, e_x(ix);;x
   409F 80            [ 4]  101     add a, b
   40A0 DD 77 01      [19]  102     ld e_x(ix), a 
                            103 
   40A3 DD 7E 04      [19]  104     ld a, e_vy(ix);;vy
   40A6 DD 46 02      [19]  105     ld b, e_y(ix);;y
   40A9 80            [ 4]  106     add a, b
   40AA DD 77 02      [19]  107     ld e_y(ix), a
   40AD C9            [10]  108 ret
                            109 
...
Hexadecimal [16-Bits]
                            ...
                            115         ;ld 1(ix), a
   40B4 DD 7E 03      [19]  116         ld a, e_vx(ix);;vx
   40B7 DD 46 01      [19]  117         ld b, e_x(ix);;x
   40BA 80            [ 4]  118         add a, b
   40BB DD 77 01      [19]  119         ld e_x(ix), a 
                            120 
   40BE DD 7E 04      [19]  121         ld a, e_vy(ix);;vy
   40C1 DD 46 02      [19]  122         ld b, e_y(ix);;y
   40C4 80            [ 4]  123         add a, b
   40C5 DD 77 02      [19]  124         ld e_y(ix), a
                            125 
   40C8 C9            [10]  126 ret
                            127 
